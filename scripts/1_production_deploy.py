...
def main():
    ...
    Deploys a Controller, a RemDIGG and your strategy under upgradable proxies and wires them up.
    ...
    # Deploy controller
    controller = Controller.at("0x3F61344BA56df00dad9bBcA05d98CA2AeC43Ba0B") ## Restitution Controller
...
def deploy_vault(controller, governance, keeper, guardian, dev, proxyAdmin):
    ...
    vault_proxy = RemDIGG.at(vault_proxy.address)
